local InspectPos = require('jjsigns.inspect.compat')

local M = {}

--- @alias Jjsigns.HlName string|integer
--- @alias Jjsigns.HlStack Jjsigns.HlName[]

--- @class Jjsigns.InspectPosItem
--- @field hl_group? Jjsigns.HlName|Jjsigns.HlStack highlight group name
...
--- @class Jjsigns.InspectPosTSItem : Jjsigns.InspectPosItem
...
--- @class Jjsigns.InspectPosExtmarkItem : Jjsigns.InspectPosItem
...
--- @class Jjsigns.InspectPosResult
--- @inlinedoc
...
--- @field treesitter Jjsigns.InspectPosTSItem[]
--- @field syntax Jjsigns.InspectPosItem[]
--- @field extmarks Jjsigns.InspectPosExtmarkItem[]
--- @field semantic_tokens Jjsigns.InspectPosExtmarkItem[]

--- @class Jjsigns.InspectItem : Jjsigns.InspectPosItem
--- @field priority integer
--- @field order integer
--- @field hl_group? Jjsigns.HlName|Jjsigns.HlStack
...
--- @field ns? string
--- @field ns_id? integer
--- @field opts? {hl_group?:Jjsigns.HlName|Jjsigns.HlStack, hl_group_link?:string, priority?:integer, ns_id?:integer, end_row?:integer, end_col?:integer}

--- @class Jjsigns.InspectRange
--- @field buffer integer
--- @field row integer
--- @field start_col integer
--- @field end_col integer
--- @field items Jjsigns.InspectItem[]

--- @class Jjsigns.HlSegment
--- @field start_col integer
--- @field end_col integer
--- @field hl Jjsigns.HlStack

--- @param groups Jjsigns.HlStack
--- @return Jjsigns.HlName|Jjsigns.HlStack
...
--- @param hl Jjsigns.HlName|Jjsigns.HlStack
--- @return Jjsigns.HlName|Jjsigns.HlStack
...
--- @param a Jjsigns.HlName|Jjsigns.HlStack
--- @param b Jjsigns.HlName|Jjsigns.HlStack
--- @return boolean
function M.same_hl(a, b)
  ...
  --- @cast a Jjsigns.HlStack
  --- @cast b Jjsigns.HlStack
  if #a ~= #b then
    return false
  end
  for i = 1, #a do
...
--- @param dest Jjsigns.HlStack
--- @param group Jjsigns.HlName|Jjsigns.HlStack|nil
function M.append_hl_group(dest, group)
  if not group or group == '' then
    return
  end
  if type(group) == 'table' then
    --- @cast group Jjsigns.HlStack
...
--- @param capture Jjsigns.InspectPosTSItem
--- @return integer
...
--- @param inspected Jjsigns.InspectRange
--- @return integer[]
...
--- @param inspected Jjsigns.InspectRange
--- @param col integer
--- @return Jjsigns.HlStack
function M.hl_stack_at(inspected, col)
  local stack = {} --- @type Jjsigns.HlStack
...
function M.inspect_range(bufnr, row, start_col, end_col)
  ...
  --- @param items Jjsigns.InspectItem[]
  --- @param item Jjsigns.InspectPosItem
  --- @param priority integer
  local function add_item(items, item, priority)
    --- @cast item Jjsigns.InspectItem
