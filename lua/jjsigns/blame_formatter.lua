...
--- @class (exact) Jjsigns.BlameLineHighlight
...
--- @return Jjsigns.BlameInfoPublic
...
--- @param chunks Jjsigns.BlameFmtChunk[]
...
function M.sanitize_chunks(chunks)
  ...
  local ret = {} --- @type Jjsigns.BlameFmtChunk[]
...
--- @param username string
--- @param info Jjsigns.BlameInfoPublic
--- @param opts? { self_author_text?: string, token_hls?: table<string, Jjsigns.HlName|Jjsigns.HlStack> }
--- @return Jjsigns.BlameFmtChunk[]
--- @return boolean
...
--- @param chunks Jjsigns.BlameFmtChunk[]
--- @return string
--- @return Jjsigns.BlameLineHighlight[]
--- @return integer
function M.render_line(chunks)
  local highlights = {} --- @type Jjsigns.BlameLineHighlight[]
