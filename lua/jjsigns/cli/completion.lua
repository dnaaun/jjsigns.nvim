local cmdline = require('jjsigns.cli.context')
local generated = require('jjsigns.cli.completion.generated')

--- @class Jjsigns.GeneratedCompletionPositional
--- @field name string
...
--- @alias Jjsigns.GeneratedCompletionFlag false|true|string[]

--- @class Jjsigns.GeneratedCompletionAction
--- @field positional Jjsigns.GeneratedCompletionPositional[]?
--- @field flags table<string, Jjsigns.GeneratedCompletionFlag>?
...
--- @param arglead string
--- @param spec Jjsigns.GeneratedCompletionPositional?
--- @return string[]
...
--- @param arglead string
--- @param name string
--- @param spec Jjsigns.GeneratedCompletionFlag
--- @return string[]
...
--- @param arglead string
--- @param flags table<string, Jjsigns.GeneratedCompletionFlag>?
--- @return string[]
local function complete_flags(arglead, flags)
  local matches = {} --- @type string[]
  local flag_specs = flags or {} --- @type table<string, Jjsigns.GeneratedCompletionFlag>
  local flag_names = vim.tbl_keys(flag_specs)
  table.sort(flag_names)

  for _, flag_name in ipairs(flag_names) do
    local flag_spec = flag_specs[flag_name] --- @type Jjsigns.GeneratedCompletionFlag
...
function M.for_action(name)
  local spec = generated.actions[name] --- @type Jjsigns.GeneratedCompletionAction?
  if not spec then
    return
  end
