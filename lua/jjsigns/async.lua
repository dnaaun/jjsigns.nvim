...
--- @type table<thread,Jjsigns.async.Task?>
...
--- @class Jjsigns.async.Handle
--- @field close fun(self: Jjsigns.async.Handle, callback?: fun())
--- @field is_closing? fun(self: Jjsigns.async.Handle): boolean

--- @alias Jjsigns.async.CallbackFn fun(...: any): Jjsigns.async.Handle?

--- @class Jjsigns.async.Task<R> : Jjsigns.async.Handle
...
--- cancel it.
--- @field private _current_child? Jjsigns.async.Handle
---
...
function Task:_resume(...)
  ...
  --- @type [boolean, string|Jjsigns.async.CallbackFn]
...
--- ```
--- @async
--- @overload fun(func: Jjsigns.async.CallbackFn): any ...
--- @overload fun(argc: integer, func: Jjsigns.async.CallbackFn, ...:any): any ...
--- @overload fun(task: Jjsigns.async.Task): any ...
function M.await(...)
...
do --- M.semaphore()
  ...
  --- @class Jjsigns.async.Semaphore
  --- @field private _permits integer
  --- @field private _max_permits integer
  --- @field package _event Jjsigns.async.Event
  local Semaphore = {}
  ...
  --- @return Jjsigns.async.Semaphore
