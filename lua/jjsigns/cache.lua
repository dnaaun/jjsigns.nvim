...
--- @class (exact) Jjsigns.CacheEntry.Blame
--- @field entries table<integer,Jjsigns.BlameInfo?>
--- @field max_time? integer
--- @field min_time? integer

--- @class (exact) Jjsigns.CacheEntry
--- @field bufnr              integer
--- @field file               string
--- @field compare_text?      string[]
--- @field hunks?             Jjsigns.Hunk.Hunk[]
...
--- @field hunks_staged?      Jjsigns.Hunk.Hunk[]
---
--- @field staged_diffs       Jjsigns.Hunk.Hunk[]
--- @field deregister_watcher? fun()
--- @field git_obj            Jjsigns.GitObj
--- @field blame?             Jjsigns.CacheEntry.Blame
--- @field commits?           table<string,Jjsigns.CommitInfo?>
...
function CacheEntry:get_rev_bufname(rev, filename)
  ...
  if filename == false then
    return ('jjsigns://%s//%s'):format(gitdir, rev)
  end
  return ('jjsigns://%s//%s:%s'):format(gitdir, rev, filename or self.git_obj.relpath)
end
...
function CacheEntry:run_blame(lnum, opts)
  ...
  local send_contents = vim.bo[bufnr].buftype == ''
    or (not self.git_obj:from_tree() and not require('jjsigns.git.version').check(2, 41))
