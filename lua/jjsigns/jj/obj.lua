...
local JJRepo = require('jjsigns.jj.repo')

--- File object for native (non-colocated) jj workspaces. Mirrors the parts of
--- `Jjsigns.GitObj` that jjsigns consumes, backed by `jj` commands instead of
...
function Obj:run_blame(contents, lnum, revision, opts)
  return require('jjsigns.jj.blame').run_blame(self, contents, lnum, revision, opts)
end
