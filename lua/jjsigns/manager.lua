...
local throttle_async = require('jjsigns.debounce').throttle_async
...
--- @class jjsigns.manager
local M = {}

--- @class (exact) Jjsigns.ManagerUpdate
--- @field bufnr                integer
--- @field bcache               Jjsigns.CacheEntry
--- @field hunks_changed        boolean
--- @field hunks_staged_changed boolean

--- @class (exact) Jjsigns.ManagerLines
--- @field bufnr     integer
--- @field bcache    Jjsigns.CacheEntry
--- @field first     integer
...
--- @class (exact) Jjsigns.ManagerWin
--- @field ns      integer
--- @field winid   integer
--- @field bufnr   integer
...
--- @class (exact) Jjsigns.ManagerLine
--- @field ns      integer
--- @field winid   integer
--- @field bufnr   integer
--- @field row     integer
...
--- @alias Jjsigns.ManagerUpdateCb fun(ctx: Jjsigns.ManagerUpdate)
--- @alias Jjsigns.ManagerLinesCb fun(ctx: Jjsigns.ManagerLines)
--- @alias Jjsigns.ManagerDetachCb fun(bufnr: integer, keep_signs?: boolean)
--- Return true to request on_line callbacks for the window.
--- @alias Jjsigns.ManagerWinCb fun(ctx: Jjsigns.ManagerWin): boolean?
--- @alias Jjsigns.ManagerLineCb fun(ctx: Jjsigns.ManagerLine)

--- @type Jjsigns.ManagerUpdateCb[]
local update_callbacks = {}

--- @type Jjsigns.ManagerLinesCb[]
local lines_callbacks = {}

--- @type Jjsigns.ManagerDetachCb[]
local detach_callbacks = {}

--- @type Jjsigns.ManagerWinCb[]
local win_callbacks = {}

--- @type Jjsigns.ManagerLineCb[]
local line_callbacks = {}

--- @param cb Jjsigns.ManagerUpdateCb
function M.on_update(cb)
  update_callbacks[#update_callbacks + 1] = cb
end

--- @param cb Jjsigns.ManagerLinesCb
function M.on_lines(cb)
  lines_callbacks[#lines_callbacks + 1] = cb
end

--- @param cb Jjsigns.ManagerDetachCb
function M.on_detach(cb)
  detach_callbacks[#detach_callbacks + 1] = cb
end

--- @param cb Jjsigns.ManagerWinCb
function M.on_win(cb)
  win_callbacks[#win_callbacks + 1] = cb
end

--- @param cb Jjsigns.ManagerLineCb
...
M.update = throttle_async({ hash = 1, schedule = true }, function(bufnr)
  ...
  update_lock(bcache, function()
    ...
    if
      ...
      and not file_mode
      and (rev_is_index or bufname:match('^fugitive://') or bufname:match('^jjsigns://'))
    then
...
M.setup = util.once(function()
  ...
  -- manager stays cheap.
  require('jjsigns.sign_renderer')
  require('jjsigns.status')
  require('jjsigns.deleted_preview')
  require('jjsigns.word_diff')

  api.nvim_create_augroup('jjsigns', { clear = false })
  ...
  require('jjsigns.current_line_blame')
end)
