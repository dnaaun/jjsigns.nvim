...
--- @field name string
--- @field group string
--- @field config table<Jjsigns.SignType,Jjsigns.SignConfig>
--- @field staged boolean
--- @field ns integer
--- @field signs table<integer,table<integer,[string,string?]?>?>
--- @field private _hl_cache table<Jjsigns.SignType,table<string,string>>
local M = {}
...
function M:hl(ty, kind)
  ...
  local result = ('JjSigns%s%s%s'):format(self.staged and 'Staged' or '', capitalise(ty), km[kind])
...
function M.new(staged)
  ...
  self.group = 'jjsigns_signs_' .. (staged and 'staged' or '')
