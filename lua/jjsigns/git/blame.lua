...
--- @class Jjsigns.BlameInfo
--- @field orig_lnum integer
--- @field final_lnum integer
--- @field commit Jjsigns.CommitInfo
...
--- @param commits table<string,Jjsigns.CommitInfo?>
--- @param result table<integer,Jjsigns.BlameInfo>
local function incremental_iter(readline, commits, result)
  ...
  commits[sha] = commit --[[@as Jjsigns.CommitInfo]]
