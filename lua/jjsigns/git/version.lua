...
local gs_config = require('jjsigns.config')

local log = require('jjsigns.debug.log')
local err = require('jjsigns.message').error
local system = require('jjsigns.system').system
local tointeger = require('jjsigns.util').tointeger
...
--- @class (exact) Jjsigns.Version
--- @field major integer
--- @field minor integer
--- @field patch integer

--- @param version string
--- @return Jjsigns.Version
