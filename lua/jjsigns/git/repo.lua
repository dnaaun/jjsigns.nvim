...
local git_command = require('jjsigns.git.cmd')
local config = require('jjsigns.config').config
local log = require('jjsigns.debug.log')
local util = require('jjsigns.util')
local Path = util.Path
local errors = require('jjsigns.git.errors')
local jj = require('jjsigns.jj')
local Watcher = require('jjsigns.git.repo.watcher')

local check_version = require('jjsigns.git.version').check

local uv = vim.uv or vim.loop ---@diagnostic disable-line: deprecated

--- @class Jjsigns.RepoInfo
--- @field gitdir string
...
--- @class Jjsigns.Repo : Jjsigns.RepoInfo
---
...
--- @field private _watcher? Jjsigns.Repo.Watcher
...
--- @type table<string,Jjsigns.Repo?>
...
--- @param spec? Jjsigns.Git.JobSpec
...
--- @return Jjsigns.RepoInfo? info, string? err
...
--- @class (exact) Jjsigns.Repo.LsTree.Result
...
--- @param path string
--- @param revision string
--- @return Jjsigns.Repo.LsTree.Result? info
--- @return string? err
...
--- @class (exact) Jjsigns.Repo.LsFiles.Result
