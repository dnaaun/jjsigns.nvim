...
---@param blame_info Jjsigns.BlameInfoPublic
---@return Jjsigns.BlameFmtChunk[]
...
--- @param bcache Jjsigns.CacheEntry
--- @param lnum integer
--- @param blame_info Jjsigns.BlameInfo
--- @param opts Jjsigns.CurrentLineBlameOpts
local function handle_blame_info(bcache, lnum, blame_info, opts)
  ...
  vim.b[bufnr].jjsigns_blame_line_dict = blame_info
  vim.b[bufnr].jjsigns_blame_line = virt_text_str
...
local function configure()
  ...
  local group = api.nvim_create_augroup('jjsigns.current_line_blame', {})
