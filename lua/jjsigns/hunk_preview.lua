...
--- @class (exact) Jjsigns.HunkPreview.SourceBuf
--- @field bufnr integer
--- @field version any
...
local preview_hls = {
  removed = {
    prefix = '-',
    line = 'JjSignsDeletePreview',
  },
  added = {
    prefix = '+',
    line = 'JjSignsAddPreview',
  },
}
...
--- @param source_cache? table<string, Jjsigns.HunkPreview.SourceBuf>
--- @param bufnr integer
--- @param lines string[]
...
local function ensure_cached_source_buf(source_cache, bufnr, lines, cache_key)
  ...
  local source_buf = source_cache[cache_key] --- @type Jjsigns.HunkPreview.SourceBuf?
...
--- @param opts? {source_cache?: table<string, Jjsigns.HunkPreview.SourceBuf>, cache_key?: string}
--- @return integer source_bufnr
--- @return fun() cleanup
...
--- @param lines Jjsigns.CapturedLine[]
--- @param line_hl? Jjsigns.HlName|Jjsigns.HlStack
--- @param word_diff? [integer, string, integer, integer][]
--- @param word_diff_hl Jjsigns.HlName|fun(region_type: string, region: [integer, string, integer, integer]): Jjsigns.HlName?
--- @param line_priority? integer
--- @param word_diff_priority? integer
--- @return Jjsigns.CapturedLine[]
...
local function word_diff_regions(removed, added, kind)
  local removed_regions, added_regions = require('jjsigns.diff_int').run_word_diff(removed, added)
...
local function removed_word_diff_regions(bufnr, hunk)
  ...
  local removed_regions = require('jjsigns.diff_int').run_word_diff(removed, added)
  return removed_regions
end

--- @param bufnr integer
--- @param source_bufnr integer
--- @param hunks Jjsigns.Hunk.Hunk[]
--- @param opts {line_hl: Jjsigns.HlName|Jjsigns.HlStack, word_diff?: boolean, word_diff_hl: Jjsigns.HlName|fun(region_type: string, region: [integer, string, integer, integer]): Jjsigns.HlName?}
--- @return Jjsigns.CapturedLine[][]
function M.capture_removed_hunks_from_source(bufnr, source_bufnr, hunks, opts)
  local ret = {} --- @type Jjsigns.CapturedLine[][]
...
--- @param hunks Jjsigns.Hunk.Hunk[]
--- @param staged boolean?
--- @param opts {source_cache?: table<string, Jjsigns.HunkPreview.SourceBuf>, line_hl: Jjsigns.HlName|Jjsigns.HlStack, word_diff?: boolean, word_diff_hl: Jjsigns.HlName|fun(region_type: string, region: [integer, string, integer, integer]): Jjsigns.HlName?}
--- @return Jjsigns.CapturedLine[][]
...
--- @param layer Jjsigns.RenderLayer
--- @param text_len integer
--- @return Jjsigns.HlMark?
...
local function render_popup_lines(lines, opts)
  ...
  local ret = {} --- @type Jjsigns.LineSpec[]
  for i, line in ipairs(lines) do
    local marks = {} --- @type Jjsigns.HlMark[]
...
local function capture_popup_lines(_bufnr, kind, source_bufnr, node, removed, added)
  local captured = apply_capture_layers(
    ...
    function(region_type)
      return kind == 'removed' and 'JjSignsDeleteInline'
        or region_type == 'add' and 'JjSignsAddInline'
        or region_type == 'change' and 'JjSignsChangeInline'
...
--- @param added_node Jjsigns.Hunk.Node
--- @return Jjsigns.LineSpec[]
