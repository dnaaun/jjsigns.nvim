...
local create_hunk = require('jjsigns.hunks').create_hunk
...
--- @alias Jjsigns.Region [integer, string, integer, integer]
--- @alias Jjsigns.RawHunk [integer, integer, integer, integer]

---@param a string
---@param b string
---@param opts Jjsigns.DiffOpts
---@param linematch? boolean
---@return Jjsigns.RawHunk[]
...
--- @param fa string[]
--- @param fb string[]
--- @param rawhunks Jjsigns.RawHunk[]
--- @return Jjsigns.Hunk.Hunk[]
local function tohunks(fa, fb, rawhunks)
  local hunks = {} --- @type Jjsigns.Hunk.Hunk[]
...
--- @param added string[]
--- @return Jjsigns.Region[] removed
--- @return Jjsigns.Region[] added
function M.run_word_diff(removed, added)
  local adds = {} --- @type Jjsigns.Region[]
  local rems = {} --- @type Jjsigns.Region[]
