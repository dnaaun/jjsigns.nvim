...
--- @class Jjsigns.RenderLayer
--- @field start_col integer
--- @field end_col integer
--- @field priority integer
--- @field hl_group Jjsigns.HlName|Jjsigns.HlStack

--- @class Jjsigns.CapturedLine
--- @field text string
--- @field layers Jjsigns.RenderLayer[]

--- @class Jjsigns.RenderVirtOpts
--- @field pad_width? integer
--- @field pad_hl? Jjsigns.HlName|Jjsigns.HlStack
--- @field default_hl? Jjsigns.HlName|Jjsigns.HlStack
--- @field pad_with_eol_hl? boolean
--- @field prefix? Jjsigns.VirtTextChunk[][]|fun(line_index: integer, line: Jjsigns.CapturedLine): Jjsigns.VirtTextChunk[]?

--- @param chunks Jjsigns.VirtTextChunk[]
--- @param text string
...
local function copy_chunks(chunks)
  local ret = {} --- @type Jjsigns.VirtTextChunk[]
...
--- @param opts Jjsigns.RenderVirtOpts
--- @param line_index integer
--- @param line Jjsigns.CapturedLine
--- @return Jjsigns.VirtTextChunk[]
local function line_prefix(opts, line_index, line)
  ...
  --- @cast prefix Jjsigns.VirtTextChunk[][]
