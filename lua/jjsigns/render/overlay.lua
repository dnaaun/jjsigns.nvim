...
--- @param layers Jjsigns.RenderLayer[]
...
--- @param hl_group Jjsigns.HlName|Jjsigns.HlStack
...
--- @param region_hl Jjsigns.HlName|fun(region_type:string, region:[integer,string,integer,integer]):Jjsigns.HlName?
--- @param priority integer
