...
--- @param item Jjsigns.InspectItem
--- @param row integer
...
--- @return Jjsigns.RenderLayer[]
local function layers_from_inspected(inspected)
  local layers = {} --- @type Jjsigns.RenderLayer[]
...
function M.capture_lines(bufnr, start_row, count, opts)
  opts = opts or {}
  local lines = {} --- @type Jjsigns.CapturedLine[]
...
--- @param line Jjsigns.CapturedLine
--- @return Jjsigns.CapturedSegment[]
function M.segments(line)
  local segments = {} --- @type Jjsigns.CapturedSegment[]
