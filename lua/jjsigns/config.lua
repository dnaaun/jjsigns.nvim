local validate = require('jjsigns.util').validate

--- @class (exact) Jjsigns.SchemaElem
...
--- @class (exact) Jjsigns.DiffthisOpts
---
...
--- @class (exact) Jjsigns.SignConfig
--- @field show_count boolean
--- @field text string

--- @alias Jjsigns.SignType
--- | 'add'
--- | 'change'
--- | 'delete'
--- | 'topdelete'
...
--- @alias Jjsigns.CurrentLineBlameFmtFun fun(
---   user: string,
---   info: table<string,any>
--- ): Jjsigns.BlameFmtChunk[]

--- @alias Jjsigns.BlameFmtChunk [string, Jjsigns.HlName|Jjsigns.HlStack?]

--- @class (exact) Jjsigns.BlameFormatterContext
--- @field max_author_width integer
--- @field hash_hl_group string

--- @alias Jjsigns.BlameFormatterFun fun(
---   user: string,
---   info: Jjsigns.BlameInfoPublic,
---   context: Jjsigns.BlameFormatterContext
--- ): Jjsigns.BlameFmtChunk[], boolean?

--- @class (exact) Jjsigns.CurrentLineBlameOpts : Jjsigns.BlameOpts
...
--- @class (exact) Jjsigns.BlameOpts
--- Ignore whitespace when running blame.
--- @field ignore_whitespace? boolean
--- Extra options passed to `git-blame`.
--- @field extra_opts? string[]

--- @class (exact) Jjsigns.Config
--- @field package _config table<string,any> config store
--- @field debug_mode boolean
--- @field diff_opts Jjsigns.DiffOpts
--- @field diffthis Jjsigns.DiffthisOpts
--- @field base? string
--- @field signs table<Jjsigns.SignType,Jjsigns.SignConfig>
--- @field signs_staged table<Jjsigns.SignType,Jjsigns.SignConfig>
...
--- @field status_formatter fun(_: Jjsigns.StatusObj): string
--- @field current_line_blame boolean
--- @field current_line_blame_formatter string|Jjsigns.CurrentLineBlameFmtFun
--- @field current_line_blame_formatter_nc string|Jjsigns.CurrentLineBlameFmtFun
--- @field current_line_blame_opts Jjsigns.CurrentLineBlameOpts
--- @field blame_formatter? string|Jjsigns.BlameFormatterFun
...
--- @alias Jjsigns.Config.SubscribersCb fun(old_val:any, new_val:any)
--- @type table<string, Jjsigns.Config.SubscribersCb[]>
local subscribers = {}
...
--- @return Jjsigns.DiffOpts
local function parse_diffopt()
  --- @type Jjsigns.DiffOpts
  local r = {
    algorithm = 'myers',
    internal = false,
...
local function warn(s, ...)
  vim.notify_once(s:format(...), vim.log.levels.WARN, { title = 'jjsigns' })
end

--- @param x Jjsigns.SignConfig
--- @return boolean
...
--- @type table<string,Jjsigns.SchemaElem>
M.schema = {
  signs = {
    type_help = 'table',
    type = validate_signs,
    ...
    description = [[
      ...
      The highlights `JjSigns[kind][type]` is used for each kind of sign. E.g.
      'add' signs uses the highlights:
        • `JjSignsAdd`   (for normal text signs)
        • `JjSignsAddNr` (for signs when `config.numhl == true`)
        • `JjSignsAddLn `(for signs when `config.linehl == true`)
        • `JjSignsAddCul `(for signs when `config.culhl == true`)

      See |jjsigns-highlight-groups|.
    ]],
  },
    ...
    description = [[
      ...
      Example: >lua
        on_attach = function(bufnr)
          ...
          -- Setup keymaps
          vim.api.nvim_buf_set_keymap(bufnr, 'n', 'hs', '<cmd>lua require"jjsigns".stage_hunk()<CR>', {})
          ... -- More keymaps
        end
<
    ]],
  ...
  show_deleted = {
    ...
    description = [[
      ...
      Note: Virtual lines currently use the highlight `JjSignsDeleteVirtLn`.
    ]],
  },
  ...
  diff_opts = {
    ...
    default_change = function(callback)
      vim.api.nvim_create_autocmd('OptionSet', {
        group = vim.api.nvim_create_augroup('jjsigns.config.diff_opts', {}),
        pattern = 'diffopt',
        callback = callback,
      })
    end,
  ...
  diffthis = {
    ...
    description = [[
      Options for the `:Jjsigns diffthis` command.
    ]],
  },
  ...
  status_formatter = {
    ...
    description = [[
      Function used to format `b:jjsigns_status`.
    ]],
  },
  ...
  preview_config = {
    ...
    description = [[
      Option overrides for the Jjsigns preview window. Table is passed directly
      to `nvim_open_win`.
    ]],
  },
  ...
  current_line_blame = {
    ...
    description = [[
      ...
      The highlight group used for the text is `JjSignsCurrentLineBlame`.
    ]],
  },
  ...
  current_line_blame_formatter = {
    ...
    description = [[
      ...
      |jjsigns-config-current_line_blame|.
      ...
      When a string, accepts the following format specifiers:
        ...
        In jj repositories, `<abbrev_sha>` is the displayed jj change id.
        `<commit_sha>` keeps the underlying commit id when available.
  ...
  current_line_blame_formatter_nc = {
    ...
    description = [[
      String or function used to format the virtual text of
      |jjsigns-config-current_line_blame| for lines that aren't committed.

      See |jjsigns-config-current_line_blame_formatter| for more information.
    ]],
  },
      ...
      When a function:
        Parameters: ~
          ...
          {blame_info} Table with the same keys as
                       |jjsigns-config-current_line_blame_formatter|.
          {context}    Table with:
  ...
  gh = {
    ...
    description = [[
      ...
      • `:Jjsigns blame_line` will show PR numbers (with a hyperlink)
    ]],
  },
    ...
    description = [[
      ...
      Uses the highlights:
        ...
        • For word diff in buffer:
          • `JjSignsAddLnInline`
          • `JjSignsChangeLnInline`
          • `JjSignsDeleteLnInline`
        • For word diff in virtual lines (e.g. show_deleted):
          • `JjSignsAddVirtLnInline`
          • `JjSignsChangeVirtLnInline`
          • `JjSignsDeleteVirtLnInline`
    ]],
  },
...
--- @param cb Jjsigns.Config.SubscribersCb
...
function M.build(user_config)
  ...
  for k, v in pairs(user_config) do
    local s = M.schema[k]
    if not s then
      warn("jjsigns: Ignoring invalid configuration field '%s'", k)
    else
      local ty = s.type
