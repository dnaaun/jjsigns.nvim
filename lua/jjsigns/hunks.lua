...
--- @alias Jjsigns.Hunk.Type
--- | "add"
--- | "change"
--- | "delete"

--- @class (exact) Jjsigns.Hunk.Node
--- @field start integer
--- @field count integer
--- @field lines string[]
--- @field no_nl_at_eof? true

--- @class (exact) Jjsigns.Hunk.Hunk
--- @field type Jjsigns.Hunk.Type
--- @field head string
--- @field added Jjsigns.Hunk.Node
--- @field removed Jjsigns.Hunk.Node
--- @field vend integer

--- @class (exact) Jjsigns.Hunk.Hunk_Public
--- @field type Jjsigns.Hunk.Type
--- @field head string
--- @field lines string[]
--- @field added Jjsigns.Hunk.Node
...
--- @param hunk Jjsigns.Hunk.Hunk
--- @param next_hunk Jjsigns.Hunk.Hunk?
...
--- Calculate signs needed to be applied from a hunk for a specified line range.
--- @param prev_hunk Jjsigns.Hunk.Hunk?
--- @param hunk Jjsigns.Hunk.Hunk
--- @param next_hunk Jjsigns.Hunk.Hunk?
--- @param min_lnum? integer
--- @param max_lnum? integer
...
--- @return Jjsigns.Hunk.Hunk?, integer?
...
--- @param a Jjsigns.Hunk.Hunk[]?
--- @param b Jjsigns.Hunk.Hunk[]?
--- @return boolean
...
function M.linespec_for_hunk(hunk, fileformat)
  local hls = {} --- @type [string, string|Jjsigns.HlMark[], string?][][]
  ...
  for _, spec in ipairs({
    { sym = '-', lines = removed, hl = 'JjSignsDeletePreview' },
    { sym = '+', lines = added, hl = 'JjSignsAddPreview' },
  }) do
  ...
  if config.diff_opts.internal then
    ...
    if no_nl_at_eof then
      local mark = { start_row = 0, end_row = 1, hl_group = 'JjSignsNoEOLPreview' }
