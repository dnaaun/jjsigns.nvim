...
--- @class jjsigns.debounce.debounce_trailing.Opts
...
---
--- @generic F: function
--- @param opts jjsigns.debounce.debounce_trailing.Opts|integer|fun():integer
...
--- @class jjsigns.debounce.throttle_async.Opts
--- @field hash? integer|fun(...): any Function that determines id from arguments to fn
...
---
--- @generic T
--- @param opts jjsigns.debounce.throttle_async.Opts
