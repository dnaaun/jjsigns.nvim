...
local function apply_word_diff(ctx)
  ...
  local _, added_regions = require('jjsigns.diff_int').run_word_diff(
    { removed_line },
    { added_line }
  )
  ...
  for _, region in ipairs(added_regions) do
    ...
    local hl_group = rtype == 'add' and 'JjSignsAddLnInline'
      or rtype == 'change' and 'JjSignsChangeLnInline'
      or 'JjSignsDeleteLnInline'
